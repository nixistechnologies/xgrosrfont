...
import 'package:xgrosr/screens/category.dart';
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider<CategoryBloc>(
          create: (context)=>CategoryBloc(repository: categoryRepository)..add(CategoryOpened()),
        )
      ], 
...
class _HomePage extends State<HomePage>{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      appBar: AppBar(title: Text("GROSRX"),),
      body: Center(
